...
- Рантайм-состояние в `data/`: `cameras.json`, `cameras_config.json`, `detect_modes.json`, `ppe_required.json` (обязательные СИЗ для пропуска, см. 2.3), `face_gallery.pkl`, `ppe.db`, `jwt_secret.txt`.
